...
namespace ShapeFill
{
    public sealed class FillDebug : MonoBehaviour
    {
        ...
        [Tooltip("Сколько обычных (не квотных) предметов «набрано» с учётом их веса в заливке")]
        ...
        private void CompleteTestFillInstantly()
        {
            _filler.Accelerate();
            _filler.Accelerate();
        }

        [ContextMenu("Stop Test Fill")]
        private void StopTestFill()
        {
            _filler.StopFill();
        }
